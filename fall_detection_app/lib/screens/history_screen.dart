...
class _HistoryScreenState extends State<HistoryScreen> {
  String _filter = 'All'; // 'All', 'Severe', 'Moderate', 'Mild'
  ...
  Widget build(BuildContext context) {
    ...
    final filteredFalls = allFalls.where((fall) {
      ...
      return fall.severity.toLowerCase() == _filter.toLowerCase();
    }).toList();
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Fall Incident History', style: TextStyle(fontWeight: FontWeight.bold)),
                ...
                ? Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'No ${_filter == "All" ? "" : _filter} fall records found',
                      ...
                      return Container(
                        ...
                        child: ListTile(
                          ...
                          leading: CircleAvatar(
                            backgroundColor: fall.severityColor.withValues(alpha: 0.15),
                            radius: 24,
                            child: Icon(fall.severityIcon, color: fall.severityColor, size: 24),
                          ),
                          title: Row(
                            children: [
                              Text(
